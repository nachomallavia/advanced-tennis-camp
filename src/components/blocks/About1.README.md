...
```astro
---
import About1 from '@/components/blocks/About1.astro';
---
...
---
import About1 from '@/components/blocks/About1.astro';
import { aboutData } from '@/components/blocks/About1Content.js';
---
...
See `About1Content.js` for example data structure. You can create your own content files following the same pattern.
